...
public class ActiveProductTest extends BaseTest {
	@Test(priority=1)
	 public void TestActiveProductPageLoads() {
        ...
        ActiveProductPage page = new ActiveProductPage (driver);
        page.clickActiveProductBtn();
        Assert.assertTrue(page.isActiveProductPageOpened(), "Active Product page not loaded successfully");
	...
	public void TestSearchKeywordFilter() {
        ...
        closePopups(1);
        ActiveProductPage page1 = new ActiveProductPage (driver);
        AllProductsPage page = new AllProductsPage(driver);
        page1.clickActiveProductBtn();
	...
	;
	 ...
	 @Test(priority = 13)
	 public void TestActiveProductView() throws InterruptedException {
	     // Step 1: Login
	     LoginPage loginPage = new LoginPage(driver);
	     loginPage.enterEmail("jump2brand@gmail.com");
	     loginPage.enterPassword("Test@123");
	     ...
	     ActiveProductPage page1 = new ActiveProductPage(driver);
	     AllProductsPage page2 = new AllProductsPage(driver);

	     // Step 3: Click Active Product button
	    page1.clickActiveProductBtn();
	   

	     // Step 4: Wait until products load
	    WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(4));
	     wait.until(ExpectedConditions.presenceOfAllElementsLocatedBy(By.cssSelector("span.activateCurrentProduct")));
	     Thread.sleep(2000); // optional for DOM stability

	     // Step 5: Verify all visible products have status = "Active"
